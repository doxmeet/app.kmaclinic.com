...
export const Route = createFileRoute("/playground/editor")({
	...
	return (
		<div className="mx-auto max-w-4xl p-6 md:p-8">
			<header className="mb-6">
				<h1 className="text-3xl font-bold text-ink">텍스트 에디터 테스트</h1>
			...
			<section className="mt-8 grid gap-6 lg:grid-cols-2">
				<div>
					...
					<pre className="max-h-80 overflow-auto rounded-md border bg-muted/30 p-3 text-xs break-all whitespace-pre-wrap">
						{value}
					</pre>
				</div>
				<div>
