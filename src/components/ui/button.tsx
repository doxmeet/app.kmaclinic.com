	...
	"group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-lg border border-transparent bg-clip-padding text-base font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
	{
		variants: {
			variant: {
				...
				// 디자인 전용: 메인 컬러 채움(그림자) / 메인 컬러 아웃라인(2px)
				brand:
					"bg-brand text-brand-foreground shadow-[0_8px_18px_-6px_rgba(42,100,246,0.45)] hover:bg-brand-700",
				"brand-outline":
					"border-2 border-brand bg-surface text-brand hover:bg-brand-50",
				"neutral-outline":
			...
			size: {
				...
				sm: "h-7 gap-1 rounded-[min(var(--radius-md),12px)] px-2.5 text-[15px] in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3.5",
