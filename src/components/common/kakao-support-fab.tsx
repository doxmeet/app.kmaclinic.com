 ...
 * 바 높이만큼 위로 올라간다. 항상 새 탭으로 안전하게 카카오톡 채널을 연다.
 */
export function KakaoSupportFab() {
	return (
		<a
			...
			className="fixed right-4 bottom-4 z-40 inline-flex items-center gap-2 rounded-full border border-brand/20 bg-brand px-4 py-2.5 text-sm font-semibold text-brand-foreground shadow-[0_8px_18px_-6px_rgba(42,100,246,0.45)] transition-colors hover:bg-brand-700 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-brand/40 [body:has([data-sticky-action-bar])_&]:bottom-20"
		>
